...
// Source: ../store_iface.go
//
// Generated by this command:
//
//	mockgen -package access -source ../store_iface.go -destination ../mock_store_iface.go
//
...
func (m *MockStore) CreatePermission(ctx context.Context, permission *accesstypes.Permission) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateResource(ctx context.Context, resource *accesstypes.Resource) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateRole(ctx context.Context, role *accesstypes.Role) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateUser(ctx context.Context, user *accesstypes.User) (int64, error) {
	m.ctrl.T.Helper()
